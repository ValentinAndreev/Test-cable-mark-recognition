...
RSpec.describe Recognition::Parser do
  ...
  let(:marks) do
    [[{ 'mark' => nil }],
     ...
     [{ 'mark' => 'ПуГВ', 'voltage' => %w[5 мВ], 'execution' => 'ХЛ', 'standard' => nil }],
     [{ 'mark' => 'ПуГВ', 'voltage' => %w[5.6 В], 'execution' => 'У', 'standard' => nil }],
     [{ 'mark' => 'ПуГВ', 'voltage' => %w[5.5 МВ], 'execution' => 'В', 'standard' => 'ГОСТ-12815-80' }]]
  end
